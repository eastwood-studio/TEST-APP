# operations_module.py — v3.11 — 1776858564
# ══════════════════════════════════════════════════════════════════════════════
...
def page_operations(can_fn, DB_PATH, fmt_eur_fn=None):
    ...
    if can_fn("finance_write"):
        _tabs += ["➕ Nouvelle opération", "🔍 OCR — Scan facture", "📥 Import en masse"]
    ...
    if can_fn("finance_write"): idx += 1
    tab_imp_ops = tab_objs[idx] if can_fn("finance_write") else None
