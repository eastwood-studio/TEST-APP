# operations_module.py — v3.9 — 1776846218
# ══════════════════════════════════════════════════════════════════════════════
        ...
        with tab_new:
            ...
            with c3:
                ...
                if _prod_sel_new == "— Saisie libre —":
                    ...
                    _article_new = _prod_noms_new[_prod_idx_new] or ""
                    st.markdown(f'<div style="font-family:DM Mono,monospace;font-size:10px;color:{EW_G};">✓ SKU : {ref_produit}</div>', unsafe_allow_html=True)

                # Fallback SKU libre si pas de produit
                sku_sel = _prod_sel_new  # compat
            ...
            info_process = st.text_input("Article / Process",
                value=_article_new if '_article_new' in dir() and _article_new else "",
