# operations_module.py — v3.19 — 1778078390
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with tab_hist:
        ...
        if df_ops.empty:
            ...
            cols_rename = {
                ...
                "ref_produit":"SKU","info_process":"Article",
                "description":"Description","categorie":"Catégorie","type_op":"Type",
                "quantite":"Qté","unite":"Unité",
                "total_ht":"HT","tva":"TVA","total_ttc":"TTC","devise":"Devise",
                "type_tva":"Type TVA","collection_op":"Collection",
            ...
            if "🔗 Facture" in df_styled.columns and "Catégorie" in df_styled.columns:
                df_styled["🔗 Facture"] = df_styled.apply(
                    lambda row: (
                        row.get("🔗 Facture","") if str(row.get("🔗 Facture","") or "").strip()
