# products_module.py — v5.30 — 1777565176
# ══════════════════════════════════════════════════════════════════════════════
# MODULE PRODUITS v3
...
def run_data_migration(conn):
    ...
    try:
        ...
        # Tout est complet → rien à faire
        if n_prods >= 14 and n_comps >= 90 and n_stock >= 35 and n_pkgs >= 4 and n_pf_in_stock >= 14:
            return
        ...
        # STOCK manquant OU produits finis absents → insérer le stock
        if n_stock < 35 or n_pf_in_stock < 14:
            try:
