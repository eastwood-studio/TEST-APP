...
# ══════════════════════════════════════════════════════════════════════════════
import os as _os2
# Sur Streamlit Cloud : la DB est dans le répertoire courant (persistant pendant la session)
# Pour une vraie persistance cross-reboot, il faudrait Supabase/PostgreSQL
