...
# ── Constantes ──────────────────────────────────────────────────────────────
RESEAUX = {
    "Instagram":   {"url": "https://www.instagram.com/eastwood.fr/",             "handle": "@eastwood.fr",       "color": "#E1306C", "objectif_semaine": 3},
    "Pinterest":   {"url": "https://fr.pinterest.com/Eastwoodstudiofr/",          "handle": "Eastwoodstudiofr",   "color": "#E60023", "objectif_semaine": 3},
    "TikTok":      {"url": "https://www.tiktok.com/@eastwood.studio",             "handle": "@eastwood.studio",   "color": "#010101", "objectif_semaine": 3},
    "TheRedNote":  {"url": "https://www.xiaohongshu.com",                         "handle": "Eastwood Studio",    "color": "#FF2442", "objectif_semaine": 3},
    "WeChat":      {"url": "https://weixin.qq.com",                               "handle": "Eastwood Studio",    "color": "#07C160", "objectif_semaine": 1},
    "LinkedIn":    {"url": "https://www.linkedin.com",                            "handle": "Eastwood Studio",    "color": "#0A66C2", "objectif_semaine": 1},
}
    ...
    {jour_date.day}
                ...
                if not df_jour.empty:
                    for _, post in df_jour.iterrows():
                        ...
                        st.markdown(f"""
<div style="background:#fff;border:0.5px solid {EW_S};border-left:2px solid {res_color};
  ...
  <div style="font-family:'DM Mono',monospace;font-size:8px;color:{stat_c};">{post.get('statut','')}</div>
