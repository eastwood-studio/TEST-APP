    ...
    with tab_book:
        ...
        if df_mod.empty:
            ...
            for _, mod in df_mod.iterrows():
                ...
                _row2 = (_cell("Taille",_ht,"0","44px") + _cell("Poids",_wt,"0","44px") +
                         _cell("Pointure",_pt,"0","52px") + _cell("Taille vêt.",_tv,"0","56px") +
                         _cell("E-mail",_mail,"1","100px") + _cell("Téléphone",_tel,"1","90px"))
                ...
                st.markdown(
                    ...
                    f'<div style="width:190px;min-width:190px;max-width:190px;background:#e8e0d4;'
