...
<div style="border:0.5px solid #e0dbd2;border-left:3px solid {done_c};
     padding:8px 12px;margin:3px 0;background:{_bg_card};">
  <div style="display:flex;justify-content:space-between;align-items:flex-start;">
    <div style="flex:1;">
      <div style="font-size:13px;font-weight:500;{done_s}color:{_clr};">{todo['titre']}</div>
      {_desc_html}
      <div style="font-family:DM Mono,monospace;font-size:8px;color:{pc};margin-top:3px;display:flex;gap:6px;align-items:center;flex-wrap:wrap;">
        <span>{todo.get('assignee','')}</span>
        <span style="color:#c8c3b8;">·</span>
        <span>{todo.get('priorite','')}</span>
        {_sub_badge}
        {_date_badge}
      </div>
    </div>
