# todo_module.py — v2.5 — 1776111550 — 1776109417 — 1775684119 — 1775681681 — 1775665335
# ══════════════════════════════════════════════════════════════════════════════
# MODULE TODO ACCUEIL
...
<div style="border:0.5px solid #e0dbd2;border-left:3px solid {bord_me};
  ...
  {desc_me}
  <div style="font-family:DM Mono,monospace;font-size:8px;color:{pc};margin-top:3px;">{prio}{sub_badge}</div>
</div>""", unsafe_allow_html=True)
...
<div style="border:0.5px solid #e0dbd2;border-left:3px solid {done_c};
  ...
  <div style="display:flex;justify-content:space-between;align-items:flex-start;">
    <div style="flex:1;">
      ...
      {_desc_html}
      <div style="font-family:DM Mono,monospace;font-size:8px;color:{pc};margin-top:3px;display:flex;gap:10px;align-items:center;">
